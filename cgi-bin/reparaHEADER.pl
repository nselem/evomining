...
`mkdir -p /var/www/html/EvoMining/cgi-bin/blast/BBH/$genomes/aux_files`;
$dir="/var/www/html/EvoMining/cgi-bin/blast/BBH/$genomes";
...
print "\nBlast1...\n";
system "blastp -db $genomesOUTDB -query $MEtCentral -outfmt 6 -num_threads 4 -evalue 0.0001 -out blast/pscp$genomes.blast";
